namespace MvcApi.Formatting
{
    ...
    {
        private static readonly MediaTypeHeaderValue _defaultTextHtmlMediaType = new MediaTypeHeaderValue("text/html");
        ...
        /// </value>
        public static MediaTypeHeaderValue TextHtmlMediaType
        {
