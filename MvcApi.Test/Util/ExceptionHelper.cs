namespace System.Web.TestUtil {
    ...
    public static class ExceptionHelper {
        ...
        public static TException ExpectException<TException>(Func<object> del) where TException : Exception {
            return ExpectException<TException>(() => { var unused = del(); }, false);
        }

        public static TException ExpectException<TException>(GenericDelegate del, bool allowDerivedExceptions) where TException : Exception {
        ...
        public static TException ExpectException<TException>(Func<object> del, bool allowDerivedExceptions) where TException : Exception {
            return ExpectException<TException>(() => { var unused = del(); }, allowDerivedExceptions);
        }

        public static TException ExpectException<TException>(GenericDelegate del, string exceptionMessage) where TException : Exception {
        ...
        public static TException ExpectException<TException>(Func<object> del, string exceptionMessage) where TException : Exception {
            return ExpectException<TException>(() => { var unused = del(); }, exceptionMessage);
        }
        ...
        public static Exception Record(GenericDelegate del) {
            try {
                del();
                return null;
            }
        ...
        public static Exception Record<T>(Func<T> del) {
            return Record(() => { var unused = del(); });
        }
    }
}
